...
describe('DateInput', () => {
    it('Should be defined', () => {
        expect(mount(<DateInput id="abc" onDateChange={jest.fn()} />)).toBeDefined();
    });

    it('Should be blank initially', () => {
        const wrapper = mount(<DateInput id="abc" dateValue={''} onDateChange={jest.fn()} />);
    ...
    it('onDateChange should return ISO formatted value string', () => {
        ...
        const component = mount(<DateInput id="abc" onDateChange={onDateChangeMock} />);
    ...
    it('ISO formatted value prop should render in DD.MM.YYYY format', () => {
        const component = mount(<DateInput id="abc" dateValue={'2019-01-01'} onDateChange={jest.fn()} />);
    ...
    it('Should render invalid date string', () => {
        const component = mount(<DateInput id="abc" dateValue={'40-30-2019'} onDateChange={jest.fn()} />);
    ...
    it('Should return invalid date string if selected date does not exist', () => {
        const onDateChangeMock = jest.fn();
        const component = mount(<DateInput id="abc" dateValue={'40-30-2019'} onDateChange={onDateChangeMock} />);
